...
- 物理结构(存储结构)：
  ...
  ![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds.png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(1).png)

#### 2.1.顺序表：

线性表的结点按逻辑次序依次存放在一组地址连续的存储单元里的方法。用顺序存储方法存储的线性表简称为顺序表。   
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(2).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(3).png)

#### 2.4.双链表：

在每个结点中除包含数值域外，设置两个指针域，分别用以指向直接前驱结点和直接后继结点，这样构成的链接表称为线性双向链接表，简称双链表。  
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(4).png)

#### 2.5.循环链表：

![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(5).png)

### 4.哈希表Hash：

HashMap 是一个散列表，它存储的内容是键值对(key-value)映射  
存储结构（简单说来就是 数组(hash桶)+链表+红黑树）  
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(6).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(7).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(8).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(9).png)

- 双端队列 ：Deque。
- 优先队列：PriorityQueue
- 循环队列  
  ![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(10).png)

### 8.树

树的基本概念  
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(11).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(12).png)
...
**性质解析**    
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(13).png)   
...
- 2.data只存在叶子节点  
  ![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(14).png)
...
![](https://wdsheng0i.github.io/assets/images/2021/datastruct/ds%20(15).png)
