...
> 学习 Spring Cloud 首先需要了解 Spring Boot，不了解 Spring Boot
> 的同学戳这里[Spring Boot学习资料汇总](https://wdsheng0i.github.io/springboot/2021/02/25/springboot-collect.html)
...
- [翟永超博客《Spring Cloud微服务实战》翟永超(著).pdf](http://blog.didispace.com/spring-cloud-learning/)
...
- [方志朋 SpringCloudLearning 示例](https://github.com/forezp/SpringCloudLearning)
