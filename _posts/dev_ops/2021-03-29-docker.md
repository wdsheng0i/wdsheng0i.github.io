...
- [Docker容器化技术，从零学会Docker教程【黑马程序员】](https://www.bilibili.com/video/BV1CJ411T7BK?spm_id_from=333.999.0.0&vd_source=fc861ca405c9ae969dbc2f0dac72ba4b)  
...
- docker exec -it c2 /bin/bash    //开个终端进去容器
- docker ps     //查看正运行镜像
- docker ps -a    //查看所有镜像
- docker stop 容器名称    //停止
...
### 2.6 Docker镜像制作和管理 Dockerfile实战-实现快速部署
#### Dockfile作用
...
#### Dockfile示例-构建spingboot镜像，并启动容器运行服务  
1.打出业务包app-demo.jar    
```mvn clean package ```
...
## 第4章 Docker 私有仓库搭建
- 1.registry 的搭建
- 2.[Harbor是一个用于存储和分发Docker镜像的企业级Registry服务器](https://blog.csdn.net/unforgettable2010/article/details/123931720)
