...
- 技术考证：软件设计师 ==> 系统架构设计师（扎实理论基础、承接项目资质） 
- 技 术 栈：前端/移动端了解；主后端、扎实基础；紧跟技术趋势（分布式、微服务、大数据、云原生） 

### 1.2 技术管理
- 岗位：TL、技术总监、CTO   
- 职责：技术发展战略、团队建设、团队提升、研发管理、项目管理、产品管理
...
- 2.工程能力git（实践）：
    - project-ability 
        - Leecode算法实例： 数据结构 + 算法
        - 设计模式实例
        - common整理：去重、择优、main验证
        - springboot组件集成实例
    - spring-cloud-ability（微服务开发示例）
    - bigdata-ability（大数据开发示例）
- 3.技术博客git（输出）：
    - 基础：计算机基础 + JAVA基础 + 多线程 + JVM + 设计模式 + 组件 + 框架
    - 架构：分布式 + 微服务 + DevOps + 云原生 + 系统设计 + 大数据
    - 管理：研发流程管理 + 项目管理 + 产品管理 + 团队管理 + 文档管理
...
- 7.架构：
    ...
    - service Mesh：Istio
    - 云原生（cloud native）：微服务 + Docker/k8s容器化 + CICD （从设计初即考虑云环境、持续部署，弹性、微服务）
- 8.性能调优：JAVA性能调优、数据库/sql调优、JVM调优、Tomcat调优、前端调优、Linux服务器调优
- 9.项目工程化(DevOps)：Maven、Git、Jenkins、Sonar、IDEA/Myeclipse、Docker/k8s、YApi、ELK、JIRA
- 10.操作系统：磁盘、cpu、内存
- 11.网络：TCP/IP、三次握手、七层网络
- 12.前端：HTML、CSS、JS、Jquery、VUE.JS、H5小程序
- 13.大数据：Hadoop框架、Hdfs存储、Mapreduce离线计算、Hbase数据库、Hive脚本分析计算、Sqoop导入导出、Flume采集、Spark内存计算、Flink实时计算、Stom实时框架
- 14.云计算：基于云服务器资源，进行分布式存储、计算 ==> 处理大数据        
    - 云服务（平台） = 云服务器 + 云存储能力 + 云计算能力（本质是大量服务器式集群，构建出的强大分布存储计算能力）
- 15.物联网知识：2G/4G/5G、通信、模组、网络、链接、设备、平台、应用、解决方案
- 16.人工智能、机器学习：
- 17.区块链-以太坊：
- 18.AR（Augmented Reality增强现实）、VR（Virtual Reality虚拟现实）
...
## 六、开发技能图谱
### 6.1 系统后端框架
![img2](../../assets/images/2021/dev-manage/bc.png)  

### 6.2 前端工程师技能
![img3](../../assets/images/2021/dev-manage/fr.png)  

![](../../assets/images/2021/dev-manage/fr2.png)  
...
![base64后-图1](../../assets/images/2021/dev-manage/saas.png)  

![图床链接-图2](../../assets/images/2021/dev-manage/pass.png)  
