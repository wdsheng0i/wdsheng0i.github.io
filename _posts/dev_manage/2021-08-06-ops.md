...
- 运维分类：
    - 业务/平台/技术运维：主要是面向业务平台SaaS、平台部署维护、业务支撑的；
    - 系统/IT运维：负责企业网络、设备、机房、主机资源、网络，操作系统的、底层IaaS的等等；
    - 安全运维：负责信息安全的；
    - 数据库DBA：是专门负责数据库；
...
- 用户、权限：sudo、chown、chmod、useradd、ssh、passwd...
- 文件管理：ll -lh、mkdir、cp、scp、mv、vi、cat、more、[grep、awk、sed](https://zhuanlan.zhihu.com/p/622707529)
- CPU：lscpu、top、
- 内存：扩缩容、free -m、
...
- 灾备、恢复
    ...
    - 【容灾备份】【数据库】[mysql数据库备份恢复方案](../dev_ops/2021-03-11-percona-xtrabackup.md)
    - 【容灾备份】【数据库】[mysql备份工具percona-xtrabackup](../dev_ops/2021-03-11-percona-xtrabackup.md)
- 数据库监控

### 2.4 数据库/存储中间件
- MySql
    - 【数据库部署】[MySql单机部署](../dev_ops/2021-03-11-mysql-1.md)
    - 【数据库部署】[MySql主从&一主多从集群部署](../dev_ops/2021-03-11-mysql-2.md)
    - 【数据库部署】[MySql双主架构部署](../dev_ops/2021-03-11-mysql-2.md)
- Mycat
...
- Redis
    - 【数据库部署】[Redis单机部署](../dev_ops/2021-03-12-redis-1.md)
    - 【数据库部署】[Redis主从部署](../dev_ops/2021-03-12-redis-2.md)
    - 【数据库部署】[Redis哨兵模式](../dev_ops/2021-03-12-redis-2.md)
    - 【数据库部署】[Redis-cluster 5.x集群部署](../dev_ops/2021-03-12-redis-2.md)
- Mongodb
    - 【数据库部署】[MongoDB单机部署](../dev_ops/2021-03-16-mongodb.md)
    - 【数据库部署】[MongoDB 3.4 分片副本集集群部署](../dev_ops/2021-03-16-mongodb.md)
- Elasticsearch
    - 【数据库部署】[ES单机部署](../dev_ops/2021-03-19-es.md)
    - 【数据库部署】[ES集群鉴权部署](../dev_ops/2021-03-19-es.md)
- Clickhouse
    - 【数据库部署】[clickhouse分析处理(OLAP)的开源列式数据库部署](../dev_ops/2021-03-21-clickhouse.md)
- Influxdb
    - 【数据库部署】[influxdb时序数据库部署](../dev_ops/2021-03-23-influxdb.md)
- TDengine
    - 【数据库部署】[TDengine时序数据库部署](../dev_ops/2021-03-24-tdengine.md)
- FastDFS
    - 【存储部署】[FastDFS + Nginx及鉴权部署](../dev_ops/2021-03-13-fastdfs.md)
- Minio
    - 【存储部署】[Minio集群部署](../dev_ops/2021-03-13-minio.md)
- SeaweedFS
    - 【存储部署】[SeaweedFS部署](../dev_ops/2021-03-13-seaweedfs.md)
- Ftp/Sftp
    - 【存储部署】Ftp部署
    - 【存储部署】Sftp部署
- Zeekeeper
...
- Etcd
    - 【组件部署】[Etcd单机部署](../dev_ops/2021-03-20-etcd.md)
    - 【组件部署】[Etcd集群部署](../dev_ops/2021-03-20-etcd.md)
- MessageQueue
    - 【组件部署】[Kafka单机部署](../dev_ops/2021-03-17-kafka1.md)
    - 【组件部署】[Kafka + zookeeper集群部署](../dev_ops/2021-03-17-kafka2.md)
    - 【组件部署】[RabbitMQ单机部署](../dev_ops/2021-03-18-rabbitmq.md)
    - 【组件部署】[RabbitMQ集群部署](../dev_ops/2021-03-18-rabbitmq.md)
    - 【组件部署】[RocketMQ单机部署](../dev_ops/2021-03-18-rocketmq.md)
    - 【组件部署】[RocketMQ双主双从集群部署](../dev_ops/2021-03-18-rocketmq.md)
      - 监控面板 [RocketMQ Dashboard](../dev_ops/2021-03-18-rocketmq.md)
- Apollo
    - 【组件部署】[Apollo部署](../dev_ops/2021-03-09-apollo.md)
- Telegraf
    - 【组件部署】[Telegraf基于插件的开源指标采集工具](https://blog.csdn.net/qq_44766883/article/details/131496094)
- Maxwell
    - 【组件部署】[maxwell部署](../dev_ops/2021-03-22-maxwell.md)

### 2.5 服务器中间件
- JDK
    - 【组件部署】[jdk安装](../dev_ops/2021-03-01-jdk.md)
- Nginx
    - 【组件部署】[nginx安装](../dev_ops/2021-03-14-nginx.md)
- Tomcat
    - 【组件部署】[tomcat安装](../dev_ops/2021-03-14-tomcat.md)
- Keepalived
    - 【中间件部署】[Keepalived安装](../dev_ops/2021-03-15-keepalived.md)
- HAProxy
    - 【中间件部署】[HAProxy](../dev_ops/2021-03-15-haproxy.md)
...
- [【1*VIP + keepalived + LVS + 2*Nginx】 实现负载均衡、高可用部署架构](../dev_ops/2021-03-15-lvs-keepalived-nginx.md)
- [【1*VIP + keepalived + 2*Nginx】 实现双机主备-高可用部署架构](../dev_ops/2021-03-15-keepalived.md)
- [【2*VIP + keepalived + 2*Nginx】 实现双主热备-高可用部署架构](../dev_ops/2021-03-15-keepalived.md)
...
### 2.7 云原生devops
- 容器 dcoker
    - 【云原生】[Docker安装及使用](../dev_ops/2021-03-29-docker.md)
    - 【云原生】[containerd安装及使用](../dev_ops/2021-03-29-containerd.md)
- 镜像 image
    - 【云原生】[编写dockerfile、build image](../dev_ops/2021-03-29-docker.md)
- 仓库 registry
    - 【云原生】[docker-registry搭建私有仓库](../dev_ops/2021-03-29-docker.md)
    - 【云原生】[harbor部署和使用](https://zhuanlan.zhihu.com/p/609602345)
- 容器编排k8s/k3s
    - 【云原生】[docker-compose安装使用](../dev_ops/2021-03-29-docker.md)
    ...
    - 【云原生】k8s集群接入私有镜像仓库
    - 【云原生】[K3s单点部署](../dev_ops/2021-03-30-k3s.md)
    - 【云原生】[使用etcd/mysql外置存储部署K3S集群](../dev_ops/2021-03-30-k3s.md)
    - 【云原生】[k3s集群接入私有镜像仓库](../dev_ops/2021-03-30-k3s.md)
    - 【云原生】helm安装使用
- 集群服务访问控制Ingress
    - 【云原生】[Ingress部署和使用](../dev_ops/2021-03-30-ingress.md)
- 集群管理面板Rancher
    - 【云原生】[Rancher部署和使用](../dev_ops/2021-03-30-rancher.md)
- CI构建：Gitlab-ci
    - 【云原生】GitlabCI基础使用
- CD部署：Argocd
    - 【云原生】[Argocd部署和使用](../dev_ops/2021-03-31-argocd.md)
- 服务网格：
    - service mesh、Istio
- 公有云/私有云：
    - 云主机、云硬盘、VPC、子网、VIP、安全组、ACL、安全组规则-白名单、弹性公网IP、弹性负载均衡SLB、Net网关、对等连接、云端口云专线...
...
- [Maven](../dev_ops/2021-03-04-maven.md)
- [Nexus](../dev_ops/2021-03-04-nexus.md)
- [Sonar](../dev_ops/2021-03-07-sonar.md)
- [Gitlab](../dev_ops/2021-03-02-git.md)
- [gitlab-ci](../dev_ops/2021-03-02-gitlab-cicd.md)
- [Jenkins](../dev_ops/2021-03-06-jenkins.md)
- 云原生CICD：
  - 【CICD】00-云原生CICD流程
  - 【CICD】01-GitlabCI基础使用
  - 【CICD】02-Kustomize基础使用(不使用ustomize直接使用原yml文件也可通过argocd正常部署到集群)
  - 【CICD】03-ArgoCD基础使用

### 2.9 监控告警
告警系统建设的重要原则：规则随生产故障补充迭代

1.指标收集/监控: [【Prometheus + Grafana】](../dev_ops/2021-03-28-prometheus.md)搭建监控平台
...
2.日志收集/监控：[【ELK(ElasticSearch、Logstash、Kibana)】](../dev_ops/2021-03-28-elk.md)、[【EFK（Fluent-bit/Fluentd）】](../dev_ops/2021-03-28-elk.md)、[【PLG(Promtail + Loki + Grafana)】](../dev_ops/2021-03-28-loki.md)搭建日志平台
  - 操作系统日志：用于安全审计、数据恢复等 系统运行日志：用于系统异常行为排查
  - 中间件日志：负载均衡、数据库、消息队列等中间件日志：用于性能瓶颈分析、故障定位
  - 业务服务日志：用于用户行为分析、程序 bug定位、故障分析

3.[Thanos](../dev_ops/2021-03-28-thanos.md)是一个开源、高可用、具有长期存储能力的 分布式Prometheus监控方案  

4.cadvisor：[cadvisor监控Pod ，prmetheus服务发现](https://blog.csdn.net/m0_37749659/article/details/130716421)

### 2.10 [网络](../cs_base/2021-01-04-net.md)
...
### 2.14 [python脚本语言](../dev_ops/2021-03-31-python.md)
