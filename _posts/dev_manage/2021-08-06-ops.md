...
- 容器编排k8s/k3s
    ...
    - 【云原生】[k8s集群接入私有镜像仓库](../dev_ops/2021-03-30-k8s.md)
    ...
    - 【云原生】helm安装使用
    - 【云原生】[Kubernetes项目TLS证书创建、配置、更新](../dev_ops/2021-03-30-k8s.md)
- 集群服务访问控制Ingress
...
1.指标收集/监控: [【Prometheus + Grafana + exporter + alertManager】](../dev_ops/2021-03-28-prometheus.md)搭建监控平台
