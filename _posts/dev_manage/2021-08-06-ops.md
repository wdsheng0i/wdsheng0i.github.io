...
- 网络：端口、协议 ifconfig、ping、netstat、telnet、traceroute、ip addr、network service、ip route
- 日志：tail、head
...
- MySql
    ...
    - 【数据库部署】[MySql双主架构部署](../dev_ops/2021-03-11-mysql-3.md)
- Mycat
...
- Redis
    ...
    - 【数据库部署】[Redis主从部署](../dev_ops/2021-03-12-redis-3.md)
    - 【数据库部署】[Redis哨兵模式](../dev_ops/2021-03-12-redis-3.md)
...
- Etcd
    - 【组件部署】[Etcd部署](../dev_ops/2021-03-20-etcd.md)
- MessageQueue
...
- 【SLB】负载均衡：后端主机组配置多个ip：port，实现高可用、负载均衡
...
- 容器编排 k8s
    ...
    - 【云原生】[使用etcd部署K3S集群](../dev_ops/2021-03-30-k3s.md)
    - 【云原生】部署Cilium作为CNI插件
