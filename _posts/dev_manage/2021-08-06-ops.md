...
- 运维分类：
    ...
    - 系统/网络/IT运维：负责企业网络、设备、机房、主机资源、网络，操作系统的、底层IaaS的等等；
...
- 容器编排k8s/k3s
    - 【云原生】[docker-compose安装使用](../dev_ops/2021-03-29-docker-compose.md)
...
- CI构建：Gitlab-ci
    - 【云原生】GitlabCI基础使用
- CD部署：Argocd
    - 【云原生】[Argocd部署和使用](../dev_ops/2021-03-30-argocd.md)
- 服务网格：
    - service mesh、Istio
- 公有云/私有云：
...
1.指标收集/监控: [【Prometheus + Grafana + exporter】](../dev_ops/2021-03-28-prometheus.md)搭建监控平台
...
1.日志收集/监控：[【ELK(ElasticSearch、Logstash、Kibana)】](../dev_ops/2021-03-28-elk.md)、[【EFK（Fluent-bit/Fluentd）】](../dev_ops/2021-03-28-elk.md)、[【LPG(Loki + Promtail + Grafana)】](../dev_ops/2021-03-28-loki.md)搭建日志平台
