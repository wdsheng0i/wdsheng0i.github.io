...
### 2.6 高可用部署架构
- 【SLB】服务端负载均衡：后端主机组配置多个ip：port，实现高可用、负载均衡
...
- [【LVS + keepalived + VIP + 2*Nginx】 实现负载均衡、高可用部署架构](../dev_ops/2021-03-15-lvs-keepalived-nginx.md)
...
- Django是一个开源的Web应用框架，由Python写成。采用了MTV的框架模式，即模型M，视图V和模版T
